...
import { deleteEntity, getEntity } from './intent.reducer';

export const IntentDeleteDialog = () => {
  ...
  const handleClose = () => {
    navigate(`/intent${pageLocation.search}`);
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="chatbotFrameworkApp.intent.delete.question">Are you sure you want to delete Intent {intentEntity.id}?</ModalBody>
      <ModalFooter>
