...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INTENTRESPONSE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_INTENTRESPONSE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_INTENTRESPONSE actions', async () => {
      const arg = { id: 24915 };
    ...
    it('dispatches UPDATE_INTENTRESPONSE actions', async () => {
      const arg = { id: 24915 };
    ...
    it('dispatches PARTIAL_UPDATE_INTENTRESPONSE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_INTENTRESPONSE actions', async () => {
      const arg = 42666;
