...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './bot.reducer';
...
describe('Entities reducer tests', () => {
  ...
  const initialState: EntityState<IBot> = {
    loading: false,
    errorMessage: null,
    entities: [],
    entity: defaultValue,
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BOT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_BOT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_BOT actions', async () => {
      const arg = { id: 6022 };
    ...
    it('dispatches UPDATE_BOT actions', async () => {
      const arg = { id: 6022 };
    ...
    it('dispatches PARTIAL_UPDATE_BOT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_BOT actions', async () => {
      const arg = 42666;
