...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './followup.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FOLLOWUP_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_FOLLOWUP actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_FOLLOWUP actions', async () => {
      const arg = { id: 20461 };
    ...
    it('dispatches UPDATE_FOLLOWUP actions', async () => {
      const arg = { id: 20461 };
    ...
    it('dispatches PARTIAL_UPDATE_FOLLOWUP actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_FOLLOWUP actions', async () => {
      const arg = 42666;
