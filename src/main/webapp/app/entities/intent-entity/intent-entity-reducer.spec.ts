...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INTENTENTITY_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_INTENTENTITY actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_INTENTENTITY actions', async () => {
      const arg = { id: 2530 };
    ...
    it('dispatches UPDATE_INTENTENTITY actions', async () => {
      const arg = { id: 2530 };
    ...
    it('dispatches PARTIAL_UPDATE_INTENTENTITY actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_INTENTENTITY actions', async () => {
      const arg = 42666;
