package io.akhilennu.chatbot.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, io.akhilennu.chatbot.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, io.akhilennu.chatbot.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            ...
            createCache(cm, io.akhilennu.chatbot.domain.Intent.class.getName() + ".followups");
            createCache(cm, io.akhilennu.chatbot.domain.Intent.class.getName() + ".entities");
            createCache(cm, io.akhilennu.chatbot.domain.IntentEntity.class.getName());
            createCache(cm, io.akhilennu.chatbot.domain.IntentEntity.class.getName() + ".intents");
            createCache(cm, io.akhilennu.chatbot.domain.Utterance.class.getName());
            createCache(cm, io.akhilennu.chatbot.domain.Followup.class.getName());
            createCache(cm, io.akhilennu.chatbot.domain.IntentResponse.class.getName());
